...
export default function LoginPage() {
  ...
  async function handleSubmit(e) {
    ...
    setLoading(true);
    try {
      const { token, user } = await loginRequest(form.id_number, form.password);
  ...
  return (
    <div
      ...
      style={{ background: "radial-gradient(ellipse at top, #0d2f2f 0%, #081a1a 50%, #040d0d 100%)" }}
    >

      {/* ── Logo ── */}
      <div className="flex flex-row items-center gap-3 mt-4">
        <div className="w-10 h-10 border-2 border-cyan-400 rounded flex items-center justify-center">
          <svg viewBox="0 0 24 24" width="20" height="20" style={{ fill: "#22d3ee" }}>
      ...
      <div
        ...
        style={{ background: "rgba(15, 35, 35, 0.85)", backdropFilter: "blur(12px)", border: "1px solid rgba(0,229,255,0.1)" }}
      >
        <h1 className="text-2xl font-bold text-white mb-1">Bienvenido</h1>
        <p className="text-gray-400 text-sm mb-6">Accede con tus credenciales</p>
      ...
      <div className="flex flex-col items-center gap-2 text-gray-500 text-xs">
        ...
        <div className="flex gap-4">
          ...
          {/* Instagram */}
          <a href="#" className="hover:text-cyan-400 transition-colors">
            <svg viewBox="0 0 24 24" width="20" height="20" style={{ fill: "none", stroke: "currentColor", strokeWidth: 2 }}>
              <rect x="2" y="2" width="20" height="20" rx="5" ry="5" />
              <circle cx="12" cy="12" r="4" />
              <circle cx="17.5" cy="6.5" r="0.5" style={{ fill: "currentColor" }} />
            </svg>
          </a>
          {/* WhatsApp */}
          <a
            href="https://wa.me/57321456789"
            target="_blank"
            rel="noreferrer"
        ...
        <p className="tracking-widest uppercase text-[10px]">Contacto tel: 321456789</p>
      </div>
